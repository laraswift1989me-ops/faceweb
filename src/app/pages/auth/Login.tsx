        ...
        <div className="bg-white dark:bg-slate-900/40 backdrop-blur-2xl border border-slate-200 dark:border-slate-800/50 rounded-[40px] p-8 lg:p-10 shadow-2xl relative">
            ...
            <div className="space-y-4">
              <div className="relative group">
                ...
                <input
                  ...
                  required
                  className="w-full bg-slate-50 dark:bg-slate-800/40 border border-slate-200 dark:border-slate-700/50 rounded-2xl py-4 pl-12 pr-4 text-slate-900 dark:text-white placeholder:text-slate-400 dark:placeholder:text-slate-500 outline-none focus:border-cyan-500/50 focus:ring-4 focus:ring-cyan-500/5 transition-all"
          ...
          <div className="mt-8 pt-8 border-t border-slate-200 dark:border-slate-800/50 text-center space-y-4">
            <p className="text-slate-500 dark:text-slate-400 text-sm font-medium">
              New to SwiftEarn?{" "}
              <Link to="/register" className="text-cyan-500 dark:text-cyan-400 font-black hover:underline ml-1 uppercase">
                Create Account
              </Link>
            </p>
            <p className="text-slate-400 dark:text-slate-600 text-xs font-bold tracking-widest uppercase">
