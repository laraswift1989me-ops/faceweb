import { ArrowRight, Zap, ShieldCheck, Users, Globe, TrendingUp, ChevronRight, PlayCircle, BarChart3, Lock, ShieldAlert } from "lucide-react";
    ...
    <div className="bg-slate-950 overflow-hidden">
      ...
      <section className="relative pt-20 pb-32 lg:pt-40 lg:pb-52 flex flex-col items-center">
        ...
        <div className="container mx-auto px-6 relative z-10 text-center">
          ...
          >
            SMART YIELD <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 via-blue-500 to-indigo-600">AI PROTOCOL</span>
          </motion.h1>
          ...
          >
            SwiftEarn leverages advanced quantitative AI to automate your DeFi staking strategy. Earn up to 1.0% daily ROI with institutional-grade security and transparency.
          </motion.p>
          ...
          >
            <div>
              <p className="text-white text-3xl font-black italic tracking-tighter">$85M+</p>
              <p className="text-slate-500 text-[10px] font-black tracking-widest uppercase mt-1">Total Value Locked</p>
            </div>
            <div>
              <p className="text-white text-3xl font-black italic tracking-tighter">125K+</p>
              <p className="text-slate-500 text-[10px] font-black tracking-widest uppercase mt-1">Active Arbitrageurs</p>
            </div>
            <div>
              <p className="text-white text-3xl font-black italic tracking-tighter">1.0%</p>
              <p className="text-slate-500 text-[10px] font-black tracking-widest uppercase mt-1">Avg Daily ROI</p>
            </div>
            <div>
              <p className="text-white text-3xl font-black italic tracking-tighter">TRC20</p>
              <p className="text-slate-500 text-[10px] font-black tracking-widest uppercase mt-1">Native Protocol</p>
            </div>
          </motion.div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-6">
          <div className="flex flex-col md:flex-row items-end justify-between gap-10 mb-20">
            <div className="max-w-2xl">
              <h2 className="text-4xl lg:text-6xl font-black text-white italic tracking-tighter uppercase leading-[0.9] mb-6">ENGINEERED FOR <span className="text-cyan-400">YIELD MAXIMIZATION</span></h2>
              <p className="text-slate-500 text-lg font-medium">Our proprietary AI core monitors 40+ decentralized exchanges 24/7 to capture market inefficiencies before they vanish.</p>
            </div>
            <Link to="/about" className="text-cyan-400 font-black italic uppercase tracking-widest flex items-center gap-2 hover:underline">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="p-10 rounded-[48px] bg-slate-900/50 border border-slate-800/50 group hover:border-cyan-500/30 transition-all">
              ...
              <h3 className="text-2xl font-black text-white italic tracking-tighter uppercase mb-4">QUANTITATIVE AI</h3>
              <p className="text-slate-500 font-medium leading-relaxed">Advanced machine learning models predict price movements and execute trades with sub-millisecond latency.</p>
            </div>
            ...
            <div className="p-10 rounded-[48px] bg-slate-900/50 border border-slate-800/50 group hover:border-indigo-500/30 transition-all">
              ...
              <h3 className="text-2xl font-black text-white italic tracking-tighter uppercase mb-4">IMMUTABLE SECURITY</h3>
              <p className="text-slate-500 font-medium leading-relaxed">Non-custodial infrastructure where your assets are protected by audited smart contracts and AES-256 encryption.</p>
            </div>
            ...
            <div className="p-10 rounded-[48px] bg-slate-900/50 border border-slate-800/50 group hover:border-blue-500/30 transition-all">
              ...
              <h3 className="text-2xl font-black text-white italic tracking-tighter uppercase mb-4">3-TIER NETWORK</h3>
              <p className="text-slate-500 font-medium leading-relaxed">Scale your earnings beyond staking with our industry-leading multi-tier referral ecosystem and real-time bonuses.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-6">
          <div className="bg-gradient-to-br from-cyan-600 to-blue-800 rounded-[64px] p-12 lg:p-24 text-center relative overflow-hidden shadow-2xl shadow-cyan-500/20">
            ...
            <div className="relative z-10 max-w-3xl mx-auto">
              <h2 className="text-4xl lg:text-7xl font-black text-white italic tracking-tighter uppercase leading-[0.9] mb-10">READY TO UPGRADE YOUR <br /> FINANCIAL OPERATING SYSTEM?</h2>
              <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
                ...
                <div className="flex items-center gap-3 px-6 py-4">
                  ...
                  <p className="text-white/80 text-xs font-black uppercase tracking-widest">+12.4k Joining Today</p>
                </div>
              </div>
            </div>
          </div>
