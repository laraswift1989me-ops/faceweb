  ...
  return (
    <div className="space-y-8 lg:space-y-12 animate-in fade-in duration-700">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div>
          <h1 className="text-4xl font-black text-slate-900 dark:text-white italic tracking-tighter uppercase mb-2">Vault & Assets</h1>
          ...
          <section className="bg-white dark:bg-slate-900 p-8 rounded-[40px] border border-slate-200 dark:border-slate-800">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                ...
                <span className="text-cyan-500 dark:text-cyan-400 text-[10px] font-black">2-12 HOURS</span>
              </div>
              <div className="h-[1px] bg-slate-200 dark:bg-slate-800 my-2" />
              <div className="flex items-center justify-between">
                <span className="text-slate-400 dark:text-slate-500 text-[10px] font-black uppercase">Encryption</span>
                <span className="text-emerald-500 dark:text-emerald-400 text-[9px] font-black tracking-widest uppercase flex items-center gap-1">
