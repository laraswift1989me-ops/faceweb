  ...
  return (
    <>
      ...
      <div className="lg:hidden flex items-center justify-between px-6 py-4
                      ...
                      backdrop-blur-md
                      border-b border-slate-200/80 dark:border-slate-800/50
                      sticky top-0 z-50">
        ...
        <div className="flex items-center space-x-4">
          ...
          <button
            ...
            className="relative p-2.5
                       bg-slate-100 dark:bg-slate-800/50
                       border border-slate-200 dark:border-slate-700/50
                       rounded-xl hover:bg-slate-200 dark:hover:bg-slate-700/50 transition-colors"
          >
            <Bell className="w-5 h-5 text-slate-600 dark:text-slate-300" />
            {unreadCount > 0 && (
          ...
          <div className="h-10 w-[1px] bg-slate-200 dark:bg-slate-700/50" />
          ...
          >
            <div className="text-right">
              <p className="text-slate-900 dark:text-white text-sm font-bold group-hover:text-cyan-500 dark:group-hover:text-cyan-400 transition-colors">
                {userName}
              </p>
              <p className="text-cyan-500 dark:text-cyan-400 text-[10px] font-bold tracking-widest uppercase">
                Level {userLevel}
              </p>
            </div>
